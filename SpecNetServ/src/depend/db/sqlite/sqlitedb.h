...
class SQLiteDB  :  public Idb  {
 public:
  ...
  bool  getNewMessages(int64_t  groupID,  int64_t  avatarID,
    ...
    int64_t  *msgIDs,  int64_t  *msgDates,  uint32_t  *resRows)  override;

  bool  getNeedMessages(int64_t  groupID,  uint64_t  *msgIDsIN, uint64_t * msgDatesIN,
    uint32_t  lenArrayIN,  int64_t  *msgIDsNEED,  int64_t  *msgDatesNEED,  uint32_t  *resRowsNEED,
  ...
  bool  storeNotNeedArray(int64_t  groupID,  uint64_t  *msgIDsIN,
    uint64_t  *msgDatesIN,  uint32_t  lenArrayIN,  int64_t  remoteAvatarID)  override;
